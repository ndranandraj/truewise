...
def _setup(tmp_path, monkeypatch):
    ...
    rows = [
        ...
        ("100", "Test State University", "TX", "Public", "5201", "Business.", "3",
         "Bachelor's Degree", 120, 70000.0, "4yr_after_completion", thr, 35000.0, 20000.0, 0.29, 0.7, "passes_earnings_premium"),
        ("100", "Test State University", "TX", "Public", "1204", "Cosmetology.", "1",
         "Certificate", 40, 20000.0, "4yr_after_completion", thr, -15000.0, 8000.0, None, None, "fails_earnings_premium"),
        ("100", "Test State University", "TX", "Public", "5138", "Nursing.", "3",
         "Bachelor's Degree", None, None, None, thr, None, None, None, None, "insufficient_data"),
    ]
