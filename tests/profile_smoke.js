  ...
  <div data-tw-profile data-tail="programs-tail.json" data-remaining="2">
    <script type="application/json" class="tw-profile-data">
      {"rows":[
        ...
        {"program":"Nursing","credential":"Bachelor's","earnings":70000,"premium":36000,"verdict":"pass","debt":22000,"payback":0.6,"completers":300}
...
const fakeFetch = async (url) => {
  ...
  return {
    programs: [
      ...
      { program: "History", credential: "Bachelor's", earnings: 44000, premium: 8000, verdict: "pass", debt: 19000, payback: 2.4, completers: 60 },
    ],
  };
};
